...
if {[file exists ${path_modelsim_libs}/.cxl.modelsim.lin64.cmd] == 0} {
	...
	catch { compile_simlib -directory ${path_modelsim_libs} -family kintex-7 -library unisim -simulator modelsim -simulator_exec_path ${path_modelsim} }
	catch { compile_simlib -directory ${path_modelsim_libs} -family kintex-7 -library simprim -simulator modelsim -simulator_exec_path ${path_modelsim}}
